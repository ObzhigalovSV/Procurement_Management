...
5. Сотрудник ОМТС (исполнитель), используя отчеты и обработки УПЗ, исходя из полученной поребности с учетом остатков на складах, формирует документ **"Заказы поставщикам"**.
